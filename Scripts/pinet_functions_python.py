...
def install_chroot_software():
    ...
    packages.append(SoftwarePackage("greenfoot-unbundled", APT))
    ...
    packages.append((SoftwarePackage("fonts-liberation2", APT)))
    packages.append((SoftwarePackage("arandr", APT)))
    packages.append((SoftwarePackage("libgl1-mesa-dri", APT)))
    packages.append((SoftwarePackage("libgles1", APT)))
    packages.append((SoftwarePackage("libgles2-mesa", APT)))
    packages.append((SoftwarePackage("xcompmgr", APT)))
    packages.append((SoftwarePackage("ffmpeg", APT)))
